...
extern "C" {
    ...
    pub fn sk_disk_open(name: *const ::libc::c_char, d: *mut SkDisk) -> ::libc::c_int;
    ...
    pub fn sk_disk_identify_parse(d: *mut SkDisk, data: *const SkIdentifyParsedData) -> ::libc::c_int;
    ...
    pub fn sk_disk_get_blob(d: *mut SkDisk, blob: *const ::libc::c_void, size: *mut size_t) -> ::libc::c_int;
    pub fn sk_disk_set_blob(d: *mut SkDisk, blob: *const ::libc::c_void, size: size_t) -> ::libc::c_int;
    pub fn sk_disk_smart_parse(d: *mut SkDisk, data: *const SkSmartParsedData) -> ::libc::c_int;
